...
function initHopAnimation() {
    ...
    function drawPixelCat(frameNum, offsetX = 0, offsetY = 0, fleeing = false) {
        ...
        // Eye pupil (vertical teardrop: narrow top, wide center, wider bottom)
        if (!isBlinking) {
            ctx.fillStyle = CAT_CONFIG.COLORS.EYE_HIGHLIGHT;
            // Left eye
            ctx.fillRect((17 + (2 - 0.35) / 2) * scale + offsetX + centerX, 17.45 * scale + yOffset + offsetY + centerY, 0.35 * scale, 0.3 * scale);
            ctx.fillRect((17 + (2 - 0.75) / 2) * scale + offsetX + centerX, 17.75 * scale + yOffset + offsetY + centerY, 0.75 * scale, 0.3 * scale);
            ctx.fillRect((17 + (2 - 1.4) / 2) * scale + offsetX + centerX, 18.05 * scale + yOffset + offsetY + centerY, 1.4 * scale, 0.3 * scale);
            ctx.fillRect((17 + (2 - 0.9) / 2) * scale + offsetX + centerX, 18.35 * scale + yOffset + offsetY + centerY, 0.9 * scale, 0.3 * scale);
            ctx.fillRect((17 + (2 - 0.6) / 2) * scale + offsetX + centerX, 18.65 * scale + yOffset + offsetY + centerY, 0.6 * scale, 0.3 * scale);
            // Right eye
            ctx.fillRect((21 + (2 - 0.35) / 2) * scale + offsetX + centerX, 17.45 * scale + yOffset + offsetY + centerY, 0.35 * scale, 0.3 * scale);
            ctx.fillRect((21 + (2 - 0.75) / 2) * scale + offsetX + centerX, 17.75 * scale + yOffset + offsetY + centerY, 0.75 * scale, 0.3 * scale);
            ctx.fillRect((21 + (2 - 1.4) / 2) * scale + offsetX + centerX, 18.05 * scale + yOffset + offsetY + centerY, 1.4 * scale, 0.3 * scale);
            ctx.fillRect((21 + (2 - 0.9) / 2) * scale + offsetX + centerX, 18.35 * scale + yOffset + offsetY + centerY, 0.9 * scale, 0.3 * scale);
            ctx.fillRect((21 + (2 - 0.6) / 2) * scale + offsetX + centerX, 18.65 * scale + yOffset + offsetY + centerY, 0.6 * scale, 0.3 * scale);
        }
