...
app.listen(PORT, '0.0.0.0', async () => {
    ...
    (() => {
        const checks = [
            ...
            [['OLLAMA_BASE_URL'],
             '🦙', 'Ollama offline LLM (sovereign tier)',
             'Cloud-only AI mode — set OLLAMA_BASE_URL (e.g. http://192.168.1.10:11434) to enable local/self-hosted sovereign AI fallback (ollama.ai)'],
            [['FRACTAL_SALT'],
             '🔐', 'Fractal ID salt',
