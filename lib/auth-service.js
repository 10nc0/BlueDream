...
// Sourced from config/brand.js — overridable via BRAND_JWT_ISSUER /
// BRAND_JWT_AUDIENCE so a fork mints tokens claiming its own identity.
// Defaults remain 'nyanbook' / 'nyanbook-app' (no behavior change).
const JWT_ISSUER = BRAND.jwtIssuer;
const JWT_AUDIENCE = BRAND.jwtAudience;
