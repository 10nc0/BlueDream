...
class PhiBreathe {
    constructor() {
        ...
        this.isProduction = process.env.NODE_ENV === 'production' || !!process.env.REPLIT_DOMAINS;
    ...
    async startPhiBreathe() {
        ...
        // In Replit, NODE_ENV can be "development" even when published.
        // We use REPLIT_DOMAINS as the truth for production.
        this.isProduction = !!process.env.REPLIT_DOMAINS;
