...
const routeModules = [
    ...
    { name: 'prometheus', register: require('../routes/prometheus').registerPrometheusRoutes, priority: 4 },
    { name: 'nyan-ai', register: require('../routes/nyan-ai').registerNyanAIRoutes, priority: 5 }
];
...
function formatPulseLog(registered, phiStatus = 'online') {
    ...
    lines.push(`🫀 PULSE │ ${timestamp} │ Vegapunk`);
