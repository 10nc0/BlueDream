...
CREATE TABLE IF NOT EXISTS core.tenant_catalog (
    ...
    ai_log_thread_id              TEXT,
    ai_log_channel_id             TEXT,
    audit_mirror_thread_id        TEXT,
    audit_mirror_channel_id       TEXT,
    audit_mirror_webhook_url      TEXT,
...
-- Durable outbox for user-configured webhook, Discord, and email deliveries.
-- The reliability migration adjusts its retry policy and adds the polling index.
