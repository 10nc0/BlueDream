...
- **Ψ-EMA Empirical Validation (35-Year Backtest)**: Framework validated across 1990-2025 (140 quarters per stock, 4 major crises). Key findings:
    ...
    - **Statistical Pattern**: Strong clustering near φ with massive effect size (Cohen's d ≈ 3.2). R ratios average ~1.60 (close to φ ≈ 1.618) across 840 quarters. Note: φ is a heuristic target inspired by natural proportions, not a proven universal constant - pattern recognition, not physics-level certainty.
