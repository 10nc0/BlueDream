...
- **Mobile Real Estate Optimization (Dec 10, 2025)**: Reduced playground header from 70px → 50px on mobile (<640px). Buttons compressed: attachment/audio 40×40 → 36×36px, send button 44×40 → 40×36px. Input container padding 1rem → 0.5rem. Cat animation margin/top eliminated (snap to top-left). Goal: maximize message display area, minimize UI chrome.
