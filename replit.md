...
- **Mobile Real Estate Optimization (Dec 10, 2025)**:
  - **Playground**: Header 70px → 50px. Buttons: attachment/audio 40×40 → 36×36px, send 44×40 → 40×36px. Input padding 1rem → 0.5rem. Cat margin/top eliminated.
  - **Dashboard**: Header 70px → 55px. Cat 75×75 → 60×60px, snapped to top-left (zero margins). All filter buttons: 44px height → 28px, padding reduced to 0.2rem. Font sizes compressed to 0.65rem. Goal: maximize message display area, minimize UI chrome.
